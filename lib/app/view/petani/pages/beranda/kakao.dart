...
import 'package:kakaoo/app/view/petani/pages/beranda/detail_kakao.dart';
import 'package:kakaoo/app/view/petani/pages/beranda/item_slider.dart';
import 'package:kakaoo/app/view/petani/pages/beranda/notifikasi.dart';
import 'package:kakaoo/app/view/petani/pages/beranda/penawaran.dart';
              ...
              children: [
                ...
                IconButton(
                    onPressed: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                Notifikasi(userId: auth.currentUser!.uid))),
                    icon: Icon(
                      Icons.notifications,
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (BuildContext context) =>
                                    Penawaran(userId: auth.currentUser!.uid)));
                      },
                      icon: Icon(Icons.forum_outlined, color: Colors.black54)),
                )
              ],
            ),
