                  ...
                  return GestureDetector(
                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          leading: Icon(Icons.close, color: Colors.red, size: 48,),
        ...
        children: [
          Align(
            ...
            child: Container(
              ...
              child: Icon(Icons.close_rounded, size: 72, color: Colors.white,)),
          ),
          SizedBox(height: 8,),
          Center(child: Text('Pesanan Ditolak', style: TextStyle(fontSize: 20))),
          SizedBox(height: 48,),
          Text('${widget.orderDate}', style: TextStyle(color: Colors.black54),),
          SizedBox(height: 4,),
          Text('Pesanan K-${widget.docIdProduct}', style: TextStyle(color: Colors.black54)),
          Divider(
            thickness: 1,
          ),
          SizedBox(
