...
import 'package:kakaoo/app/view/tengkulak/pages/beranda/detail_produk/lihat_profil.dart';
import 'package:kakaoo/app/view/tengkulak/pages/beranda/detail_produk/pesanan.dart';
import 'package:kakaoo/app/view/tengkulak/pages/beranda/detail_produk/rute.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Minimum Pembelian ${widget.minimumBuy} ${widget.unit}',
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                        onPressed: () async {
                          String priceOffer = _controllerPrice.text;

                          await firestore.collection('penawaran').add({
                            'userId': widget.userIdPetani,
                            'docIdProduct': widget.docIdProduct,
                            'harga': widget.price,
                            'penawaran harga': priceOffer,
                            'imageFile': widget.imageFile
                          });
