...
class _RuteState extends State<Rute> {
  final String _apiKey = "AIzaSyAISwXwMy9RIBS6qnrxkC3fPRL3hfSrJSg";
  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      double destinationLatitude = _destinationAddress == widget.location
          ? widget.coordinate.latitude
          : destinationPlacemark[0].latitude;

      double destinationLongitude = _destinationAddress == widget.location
            ...
            SafeArea(
              child: Align(
                ...
                child: Padding(
                  ...
                  child: ClipOval(
                    child: Material(
                      color: AppColor().colorCreamy, // button color
                      child: InkWell(
                        // inkwell color
                        child: SizedBox(
                          width: 56,
